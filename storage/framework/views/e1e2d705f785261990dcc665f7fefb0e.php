    ...
    <div class="col-md-8">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="float-end">
                    <a href="<?php echo e(route('products.index')); ?>" class="btn btn-primary btn-sm">&larr; atrás</a>
                </div>
            </div>
            <div class="card-body">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/laravel/laravel-11-crud-master/resources/views/products/create.blade.php ENDPATH**/ ?>